...
const Dashboard: FunctionComponent = () => {
    ...
    return <div className="w-full h-full grid place-items-center">
        <div className="lg:w-6/12 md:w-8/12 w-11/12  h-80 grid place-items-center rounded border">
            ...
            <p className="text-gray-600 w-11/12 md:w-9/12 text-center">Bienvenu(e) sur MUSACOM. Vous êtes connecté(e) en tant que <b>{uppercaseFirst(user?.names) }</b> et {user?.staff ? "vous faites partie de membres du staff(ou administrateur).": "vous no-staff utilisateur."} Bonne utilisation !</p>
