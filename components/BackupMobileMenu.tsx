  ...
  return (
    ...
    >
      <div className="h-auto mb-3 px-2 pt-4 w-full rounded  shadow relative flex flex-col justify-around">
        ...
        <BackupMenuItem event={onClick} path="/firm" text="Cicursale" />
        <BackupMenuItem event={onClick} path="/exercise" text="Exercice" />
        <BackupMenuItem event={onClick} path="/cohorte" text="Cohorte" />
        <BackupMenuItem event={onClick} path="/member" text="Membre" />
        <BackupMenuItem event={onClick} path="/enrolement" text="Enrolement" />
        <BackupMenuItem event={onClick} path="/payment" text="Paiement" />
        <BackupMenuItem event={onClick} path="/tracked" text="Bon et suivi" />
      </div>
    </div>
  );
};
