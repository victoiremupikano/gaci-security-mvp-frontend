...
export default function Index() {
  ...
  return (
    <>
      <ReusableHeader text="Toutes les adresses mail" />
      <div className="w-11/12 mx-auto h-full">
        ...
        <div className="flex justify-between border-b text-sm p-1 font-semibold">
          ...
          <span className="w-2/12 text-center">Adresse mail</span>
            ...
            newsLetter.map((a, index) => {
              return (
                ...
                >
                  ...
                  <span className="md:w-2/12 text-center">{a.email}...</span>
                  ...
                  <span className="md:w-1/12 w-2/12 flex justify-around">
                    <Link
                      href={"/staff/news-letter/" + a.pk + "/update"}
