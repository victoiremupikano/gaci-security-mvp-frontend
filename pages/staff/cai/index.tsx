...
export default function Index() {
  ...
  return (
    <>
      <ReusableHeader text="Toutes les couvres-feu" />
      <div className="w-11/12 mx-auto h-full">
        <div className="w-full mb-3 mt-4 flex justify-between">
          <div className="flex items-center">
            <GoBack />{" "}
            <span className="font-semibold text-xl">Toutes les couvres-feu</span>
          </div>
        ...
        <div className="flex justify-between border-b text-sm p-1 font-semibold">
          ...
          <span className="w-2/12 text-center">Motif</span>
