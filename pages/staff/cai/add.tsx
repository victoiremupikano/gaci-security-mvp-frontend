...
export default function AddCai() {
  const inputRef = useRef<any>();
  const [{ reason, longitude, latittude}, handleChange] = useForm({
    reason: "",
    longitude: "",
    latittude: "",
    picture64: "",
  ...
  if (showSuccessBox)
    return (
      <UserSuccessBox
        ...
        path="/staff/cai"
        message="Le couvre-feu a été créé avec succès, vous pouvez maintenant vous connecter sur le consulter."
      />
    );
  return (
    <>
      <ReusableHeader text="Nouveau couvre-feu" />
        ...
        <div className="border h-auto pb-2 flex flex-col justify-around rounded w-full">
          <div className="flex flex-col items-center">
            <div className="w-11/12">
              <FormHeader title="Nouveau couvre-feu" />
            </div>
