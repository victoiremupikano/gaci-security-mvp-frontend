...
export default function IndexProfile() {
  ...
  return (
    <>
      ...
      <div className="h-full mb-3 overflow-hidden relative  w-11/12 md:w-6/12 mx-auto">
              ...
              <div>
                <div className="h-56 rounded-lg mb-3 overflow-hidden mx-auto  w-56">
                  <Image
                    ...
                    alt={
                      (profile.user && profile.user?.names) || "Person's" + "'s profile image"
                    }
                    height="0"
                    width="0"
                  />
                ...
                <div className=" w-full p-1 flex-col flex ">
                  ...
                  <div className="flex  mb-3">
                    ...
                    >
                      ...
                      <span className="font-semibold ml-1">{profile.user?.names}</span>{" "}
