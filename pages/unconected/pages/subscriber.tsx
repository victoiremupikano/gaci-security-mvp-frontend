                ...
                <div className="content text-gray-600 text-lg flex flex-col gap-4">
                    ...
                    <ol>
                        <li className="text-gray-600">
                            - Les personnes vulnérables accèdent aux soins de qualité qui leur étaient privés;
                        </li>
                        <li className="text-gray-600">
                            - Les bénéficiaires sont hospitalisés dans des bonnes conditions;
                        </li>
                        <li className="text-gray-600">
                        ...
                        <li className="text-gray-600">
                            - Les soins donnés aux membres sont contrôlés par le Comité Exécutif de la MUSACOM;
                        </li>
                        <li className="text-gray-600">
                            - Le taux de dettes dans les hôpitaux et centres de santé est réduit.
                        </li>
                    </ol>
                    <strong>COMMENT ADHERER ?</strong>
                    Pour bénéficier des services de la MUSACOM, chaque membre paie 18 $ par an. 
                    <p>
                        Cette cotisation est individuelle, non remboursable. 
                    </p>
                    <p>
                        Les institutions qui affilient leur personnel sont éligibles aux soins après avoir payé seulement 50% du montant dû pour la cotisation. 
                    </p>
                    <p>
                        Les 50% restant sont payés en 2 tranches de 25% dans les 6 mois qui suivent le premier versement. 
                    </p>         
                    <p>
