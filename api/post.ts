...
const Post = {
  async add(
    ...
    return api.post(
      "/post-list-create/" + entreprize_id + "/",
      data,
      "share_pub"
    );
  },
  ...
  async getStaff(
    ...
    return api.get(
      "/post-staff-detail/" + id + "/" + entreprize_id,
      "share_pub"
    );
  },
  async getNoStaff(
    ...
    return api.get(
      "/post-no-staff-detail/" + id + "/" + entreprize_id,
      "share_pub"
    );
  },
  ...
  // les fx pour l'user unconnected
  async getPostAllPublishedAndPopular(
    entreprize_id: string
  ): Promise<PostAPIResponse> {
    return api.get(
      "/post-published-popular-list/" + entreprize_id,
      "share_pub"
    );
  },
  // les fx pour l'user unconnected
  async getPostAllPublishedAndRepost(
    entreprize_id: string
  ): Promise<PostAPIResponse> {
    return api.get("/post-published-repost-list/" + entreprize_id, "share_pub");
  },
  // les fx pour l'user unconnected
  async getPostAllPublishedAndFavorisByUserLogged(
    entreprize_id: string
  ): Promise<PostAPIResponse> {
    return api.get(
      "/post-published-favoris-user-list/" + entreprize_id,
      "share_pub"
    );
  },
};
