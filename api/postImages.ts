...
const PostImages = {
  async add(data: Record<string, any>, entreprize_id:string): Promise<PostImagesAPIResponse> {
    return api.post(
      "/post-images-list-create/" + entreprize_id + "/", data, "share_pub"
    );
  },
  async update(data: Record<string, any>, id: string): Promise<PostImagesAPIResponse> {
