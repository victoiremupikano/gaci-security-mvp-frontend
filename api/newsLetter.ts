...
const NewsLetter = {
  ...
  ): Promise<FnAPIResponse> {
    return api.post(
      "/subsriber-news-letters-list-create/" + entreprize_id + "/",
      data,
      "share_param"
    );
  },
  async addNoStaff(
    ...
    return api.post(
      "/subsriber-news-letters-create/" + entreprize_id + "/",
      data,
      "share_param"
    );
  },
  async update(data: Record<string, any>, id: string): Promise<FnAPIResponse> {
    return api.put(
      "/subsriber-news-letters-update/" + id + "/",
      data,
      "share_param"
    );
  },
  async delete(id: string): Promise<FnAPIResponse> {
    return api.delete(
      "/subsriber-news-letters-delete/" + id + "/",
      "share_param"
    );
  },
  ...
  async get(
    ...
    return api.get(
      "/subsriber-news-letters-detail/" + id + "/" + entreprize_id,
      "share_param"
    );
  },
};
